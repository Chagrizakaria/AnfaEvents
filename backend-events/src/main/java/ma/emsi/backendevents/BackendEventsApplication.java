...
public class BackendEventsApplication {
    ...
    @Bean
    CommandLineRunner cm(UserRepository userRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            userRepository.findAll().forEach(u -> {
                System.out.println("Existing user: " + u.getFullName() + " | Role: " + u.getRole());
            });

            // Promote chagri@gmail.com to ADMIN if the user exists
